            ...
            <Container maxWidth="lg">
              <Grid container spacing={{ xs: 4, md: 4 }}>
                ...
                <Grid size={{ xs: 12, sm: 6, md: 4 }}>
                  ...
                  >
                    Curated collections, unbeatable prices — shop smarter with
                    our handpicked catalog, delivered right to your door.
                  </Typography>

                  {/* Social icons */}
                  <Stack direction="row" spacing={1} pt={2.5}>
                    {[
                      FacebookIcon,
                      InstagramIcon,
                      TwitterIcon,
                      ...
                      <IconButton
                        ...
                        sx={{
                          ...
                          "&:hover": {
                            backgroundColor: "rgba(215, 190, 165, 0.18)",
                          },
                        }}
                      >
                        <Icon fontSize="small" />
              ...
              <Stack
                ...
                spacing={2}
              >
                <Typography sx={{ color: "#8A7B70", fontSize: "0.82rem" }}>
